...
var VYucx = function (_Component) {
  _inherits(VYucx, _Component);

  function VYucx() {
    _classCallCheck(this, VYucx);

    return _possibleConstructorReturn(this, (VYucx.__proto__ || Object.getPrototypeOf(VYucx)).apply(this, arguments));
  }
...
_metalSoy2.default.register(VYucx, _step_2Soy2.default);

exports.default = VYucx;
...
exports.templates = exports.VYucx = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace VYucx.
   * @public
   */

  goog.module('VYucx.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param434 = function param434() {
      ...
      ie_close('p');
      ie_open('p');
      itext('Mapper.apex uses Func objects from R.apex, and a Func is actually a custom Apex object that mimics the behavior of a function.');
      ie_close('p');
      ie_open('p');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'VYucx.render';
  }
...
_metalSoy2.default.register(VYucx, templates);
exports.VYucx = VYucx;
