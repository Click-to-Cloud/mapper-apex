...
var zfqZp = function (_Component) {
  _inherits(zfqZp, _Component);

  function zfqZp() {
    _classCallCheck(this, zfqZp);

    return _possibleConstructorReturn(this, (zfqZp.__proto__ || Object.getPrototypeOf(zfqZp)).apply(this, arguments));
  }
...
_metalSoy2.default.register(zfqZp, _step_1Soy2.default);

exports.default = zfqZp;
...
exports.templates = exports.zfqZp = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace zfqZp.
   * @public
   */

  goog.module('zfqZp.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param423 = function param423() {
      ie_open('h2');
      ...
      ie_close('p');
      ie_open('p');
      itext('Then, we will include Mapper.apex.');
      ie_close('p');
      ie_open('p');
      itext('Include ');
      ie_open('strong');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'zfqZp.render';
  }
...
_metalSoy2.default.register(zfqZp, templates);
exports.zfqZp = zfqZp;
